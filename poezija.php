...
<main>
    <button>Prikaži po autorima</button>
    <ul>
    ...
    <div class="knjige columns zastave">
        <article>
            ...
            <ul>
                ...
                <li><a href="poezija/zumberacko-kolo.php">Žumberačko kolo</a></li>
        ...
        <article>
            ...
            <ul>
                ...
                <li><a href="poezija/popovicu-milorade-kukavice-tako-rade.php">Popoviću Milorade kukavice tako rade</a></li>
        ...
        <article>
            ...
            <ul>
                ...
                <li><a href="poezija/sumadijo-ti-si-prva-bila.php">Šumadijo ti si prva bila</a></li>
                <li><a href="poezija/crnotravski-mi-smo-partizani.php">Crnotravski mi smo partizani</a></li>
                <li><a href="poezija/crna-travo-ti-planinsko-mesto.php">Crna Travo ti planinsko mesto</a></li>
                ...
                <li><a href="poezija/drug-tito-zove.php">Drug Tito zove</a></li>
                ...
                <li><a href="poezija/oj-jelice-je-l-ti-zao.php">Oj Jelice jel ti žao</a> (Ratku Mitroviću)</li>
                <li><a href="poezija/u-planini-i-u-gori.php">U planini i u gori</a> (Ratku Pavloviću)</li>
                ...
                <li><a href="poezija/oj-devojko-drugarice.php">Oj devojko drugarice</a></li>
                ...
                <li><a href="poezija/bjela-vilo-kazi-pravo.php">Bjela vilo kaži pravo</a></li>
                ...
                <li><a href="poezija/jednog-dana-pismo-stize.php">Tvoj je sinak poginuo</a></li>
...
<script>
    function showByAuthors() {
        ...
        const html = Object.entries(dict)
            ...
            .map(([name, list]) => (`<article><h4>${name}</h4><ul>${list}</ul></article>`))
            .join('')

        document.querySelector('main').innerHTML = `
            <button onClick="window.location.reload()">Vrati podrazumevano</button>
            <div class="knjige columns">${html}</div>
        `
    }

    document.querySelector('button').addEventListener('click', showByAuthors)
</script>
