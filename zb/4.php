...
$zbornici_po_knjigama[14]=array('1941 i 1942','januar - septembar 1943','septembar 1943 - juli 1944','avgust 1944 - maj 1945');

$maxx[12]=array(927,1241,925,1320);	
$maxx[13]=array(896,1038,596);	
$maxx[14]=array(954,1113,1046,1178);	
...
$aa=$aa . "<tr><td colspan=" . $ct . "><center>" . $zbornici_po_knjigama[$tom_index][$broj_knjige-1] . "</center></td></tr></table></form></center>";
...
function set_vol(vol) {
	...
	if(vol!=12 & vol!=13 & vol!=14) {window.open(res);}
...
<b class=bigTitle>tom <?php echo into_roman($tom_index) . "<br>knjiga "  . $broj_knjige . ": " . $zbornici_po_knjigama[$tom_index][$broj_knjige-1];?>
...
<?php echo $aa;?>
</td><td vAlign=top rowspan=<?php echo $broj_poglavlja+1;?> width="60%" style="overflow-x:hidden;"><center>
<?php
echo '<iframe src=' . '"' . '/zb/' . $pddf . '#page=' . $ova_strana . '"' . ' style=' . '"' . 'position:relative; left:0px; text-align: left; width:100%; height:1600; overflow-x:hidden;' . '"' . '></iframe></td></tr>';
for ($ii=1;$ii<$broj_poglavlja+1;$ii++) {
