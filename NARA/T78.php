...
<title>German Supreme Army Command (Oberkommando des Heeres) Documents from National Archive Washington
</title>
...
$upit1="SELECT * FROM roll_s WHERE rec=78 AND roll=" . $kontrol . ";";
...
$upit2="SELECT * FROM roll_c WHERE rec=78 AND roll=" . $kontrol . ";";
...
<table>
<tr>
	<td><input type="submit" value="T78, roll no."></td>
	<td><font size="4">[</font><input type="radio" name="pripadnost" id="c1" value="331"><font size="4"><label for="c1">331</label>]</font></td>
	<td><font size="4">[</font><input type="radio" name="pripadnost" id="c2" value="332"><font size="4"><label for="c2">332</label>]</font>
	</td>
</tr>
</table>
</form>
...
<br><b class=bigTitle>German Supreme Army Command (Oberkommando des Heeres) Documents from National Archive Washington
</b>
<br>
...
<tr><td align=center class=svetloplavo colspan=3><center><b class=bigTitle><u>&nbsp;&nbsp; German Supreme Army Command (Oberkommando des Heeres), T<?php echo $rec[0];?> roll <?php echo $roll[0];?>&nbsp;&nbsp;</u></td></tr>
