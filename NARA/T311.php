...
<title>German Army Group F Headquarters (Heeresgruppe F Oberkommando) Documents from National Archive Washington
</title>
...
$upit1="SELECT * FROM roll_s WHERE rec=311 AND roll=" . $kontrol . ";";
//echo "-----" . $upit1;
...
$upit2="SELECT * FROM roll_c WHERE rec=311 AND roll=" . $kontrol . " ORDER BY frm;";
//echo "***" . $upit2;
...
<table>
<tr>
	<td><input type="submit" value="T311, roll no."></td>
	<td><font size="4">[</font><input type="radio" name="pripadnost" id="c1" value="187"><font size="4"><label for="c1">187</label>]</font></td>
	<td><font size="4">[</font><input type="radio" name="pripadnost" id="c2" value="188"><font size="4"><label for="c2">188</label>]</font></td>
	<td><font size="4">[</font><input type="radio" name="pripadnost" id="c3" value="189"><font size="4"><label for="c3">189</label>]</font></td>
	<td><font size="4">[</font><input type="radio" name="pripadnost" id="c4" value="190"><font size="4"><label for="c4">190</label>]</font></td>
	<td><font size="4">[</font><input type="radio" name="pripadnost" id="c5" value="194"><font size="4"><label for="c5">194</label>]</font></td>
	<td><font size="4">[</font><input type="radio" name="pripadnost" id="c6" value="195"><font size="4"><label for="c6">195</label>]</font></td>
	<td><font size="4">[</font><input type="radio" name="pripadnost" id="c7" value="196"><font size="4"><label for="c7">196</label>]</font></td>
	<td><font size="4">[</font><input type="radio" name="pripadnost" id="c8" value="285"><font size="4"><label for="c8">285</label>]</font></td>
	<td><font size="4">[</font><input type="radio" name="pripadnost" id="c9" value="286"><font size="4"><label for="c9">286</label>]</font>
	</td>
</tr>
</table>
</form>
...
<br><b class=bigTitle>German Army Group F Headquarters (Heeresgruppe F Oberkommando) Documents from National Archive Washington
</b>
<br>
...
<tr><td align=center class=svetloplavo colspan=3><center><b class=bigTitle><u>&nbsp;&nbsp; German Army Group F Headquarters (Heeresgruppe F Oberkommando), T<?php echo $rec[0];?> roll <?php echo $roll[0];?>&nbsp;&nbsp;</u></td></tr>
...
<?php
for ($ii=1;$ii<$broj_poglavlja+1;$ii++) {
	//echo $broj_poglavlja . $rec[0] . '_' . $roll[0] . '/' . $ova_strana_str;
