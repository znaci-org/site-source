...
<tr><td colspan="4" height="800px" valign=top><center>
<div style="background-image: url(/images/20836c.jpg); background-repeat: repeat-x;" width="800px" height="800px">
...
while(1) {
	...
	$upit_sx="SELECT * FROM eventu WHERE ko=" . $gradovi[$rr] . " order by kadyy,kadmm,kadd;";
	//echo $upit_sx . "<br>";
	...
	while(1) {
		$red_sx=mysqli_fetch_assoc($rezultat_sx);
	...
	if ($ishod==1) {
		...
		$duzina=($red_g['e'] - 13) * 68 + 32;
		$sirina=(47 - $red_g['n']) * 105 + 66;
		echo "<div class=bigTitle_c style=" . chr(34) . "position: relative; left:" . $duzina . "px; top:" . $sirina . "px;" . chr(34) . ">*" . $ovaj_grad . "</div>";
	}
...
?>
</div></td><td>dan, mesec i godina: <input type="text" name="dd" /><input type="text" name="mm" /><input type="text" name="yy" /><br><br><br>
<?php
