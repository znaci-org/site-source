...
$br_knj=755;
$autor="";
$nasl_knj="BOSANSKI PETROVAC U NOB, ZBORNIK SJEĆANJA – KNJIGA 2";
if 	(!($_SESSION['id'])) { 
$ova_strana = 6;
} else {
...
</TD><TD><form name="input2" action="<?php $_SERVER[PHP_SELF]; ?>" method="get"><b>page no: (1-<?php echo $maxx;?>)</b>: <input type="text" name="broj" value=<?php echo $ova_strana;?>><input type="submit" value="go!" name="go!"></form>
