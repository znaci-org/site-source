...
$br_knj=600;
$autor="Stevo Ostoji&#263;";
$nasl_knj="NA&#352;E GODINE &#8211; Nova Jugoslavija s naslovnih strana 1943-1983";
if ($_GET['broj']) {
...
for ($ii=1;$ii<$broj_poglavlja+1;$ii++) {
	...
	if ($ii==1) {
		echo substr($spx,0,strlen($spx)-5) . '<td align=' . '"' . 'center' . '"' . 'vAlign=' . '"' . 'top' . '"' . ' rowspan=' . $broj_poglavlja . ' width=' . '"' . '80%' . '"' . '><center><img src=' . '"' . '/images/600/600 - ' . nulle($ova_strana) . '.jpg' . '"' . ' style=' . '"' . 'width:100%; ' . '"' . '></td></tr>';
	} else {
		echo $spx;
	}
