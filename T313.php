...
$upit2="SELECT * FROM roll_c WHERE rec=313 AND roll=" . $kontrol . ";";
$rezultat = mysqli_query($konekcija,$upit2);
$red2 = mysqli_fetch_assoc($rezultat);
$dt1[$rrr2]=strtotime($red2['dt1']);
$dt2[$rrr2]=strtotime($red2['dt2']);
...
<tr>
	...
	<td>[<input type="radio" name="pripadnost" id="c1" value="192"><label for="1">192</label>]</td>
	<td>[<input type="radio" name="pripadnost" id="c2" value="482"><label for="2">482</label>]</td>
	<td>[<input type="radio" name="pripadnost" id="c3" value="483"><label for="3">483</label>]</td>
	<td>[<input type="radio" name="pripadnost" id="c4" value="484"><label for="4">484</label>]</td>
	<td>[<input type="radio" name="pripadnost" id="c5" value="485"><label for="5">485</label>]</td>
	<td>[<input type="radio" name="pripadnost" id="c6" value="486"><label for="6">486</label>]</td>
	<td>[<input type="radio" name="pripadnost" id="c7" value="487"><label for="7">487</label>]</td>
	<td>[<input type="radio" name="pripadnost" id="c8" value="488"><label for="8">488</label>]
	<input type="hidden" id="c9" name="f1_prip" value="1"></td>
</tr>
</table>
</form>
</center>
...
for ($ii=1;$ii<$broj_poglavlja+1;$ii++) {
	...
	$spx='<tr><td vAlign=top ' . $boja[$ii] . '> <a href=' . '"' . 'T' . $rec[0] . '.php?' . 'broj=' . $img[$ii-1] . '&f2_strn=' . $kontrol . '"' . '>' . $opis_n[$ii-1] . ' - ' . $opis_e[$ii-1] . ', ' . $dt1[$ii-1] . ' - ' . $dt2[$ii-1] . '</a>' . $sp4 . $frrm[$ii-1] . $slika[$ii-1] . $sp5;
	echo $spx;
	echo "\n";
}
?>
