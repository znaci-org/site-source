...
$conn_id = ftp_connect("jcarlcalvin.ddns.net");
$login_result = ftp_login($conn_id, "FTP-User-1", "SKNVr8du");
print_r($login_result);

//0:/Microfilm Rolls/German Units - Armies/T-312 R-455 AOK 12/

for ($xx=907;$xx<912;$xx++) {
$f_n=$xx;
for ($ii=1;$ii<4;$ii++) {
...
$local_file = $f_n;
$server_file = '/Microfilm Rolls/German Units - Armies/T-312 R-455 AOK 12/' . $f_n;
